...
public class FindPath {
    ...
    public FindPath(int rows, int cols, Node initialNode, Node finalNode, int hvCost, int diagonalCost) {
        this.hvCost = hvCost;
    ...
    public FindPath(int rows, int cols, Node initialNode, Node finalNode) {
